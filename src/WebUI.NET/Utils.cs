...
namespace WebUI
{
    ...
    public static class Utils
    {
        ...
        /// <summary>
        /// Sets the maximum time WebUI will wait for the browser to starts
        /// </summary>
        ...
        {
            [LibraryImport(LibraryName, StringMarshalling = StringMarshalling.Utf8, EntryPoint = "webui_wait")]
            [UnmanagedCallConv(CallConvs = new[] { typeof(CallConvCdecl) })]
            public static partial void WebUIWait();

            [LibraryImport(LibraryName, StringMarshalling = StringMarshalling.Utf8, EntryPoint = "webui_exit")]
            [UnmanagedCallConv(CallConvs = new[] { typeof(CallConvCdecl) })]
            public static partial void WebUIExit();

            [LibraryImport(LibraryName, StringMarshalling = StringMarshalling.Utf8, EntryPoint = "webui_clean")]
            [UnmanagedCallConv(CallConvs = new[] { typeof(CallConvCdecl) })]
            public static partial void WebUIClean();

            [LibraryImport(LibraryName, StringMarshalling = StringMarshalling.Utf8, EntryPoint = "webui_delete_all_profiles")]
            [UnmanagedCallConv(CallConvs = new[] { typeof(CallConvCdecl) })]
            public static partial void WebUIDeleteProfiles();

            [LibraryImport(LibraryName, StringMarshalling = StringMarshalling.Utf8, EntryPoint = "webui_set_default_root_folder")]
            [UnmanagedCallConv(CallConvs = new[] { typeof(CallConvCdecl) })]
            [return: MarshalAs(UnmanagedType.I1)]
            public static partial bool WebUISetDefaultRootFolder(string folder);

            [LibraryImport(LibraryName, StringMarshalling = StringMarshalling.Utf8, EntryPoint = "webui_set_timeout")]
            [UnmanagedCallConv(CallConvs = new[] { typeof(CallConvCdecl) })]
            public static partial void WebUISetTimeout(UIntPtr seconds);

            [LibraryImport(LibraryName, StringMarshalling = StringMarshalling.Utf8, EntryPoint = "webui_encode")]
            [UnmanagedCallConv(CallConvs = new[] { typeof(CallConvCdecl) })]
            public static partial string WebUIEncode(string content);

            [LibraryImport(LibraryName, StringMarshalling = StringMarshalling.Utf8, EntryPoint = "webui_decode")]
            [UnmanagedCallConv(CallConvs = new[] { typeof(CallConvCdecl) })]
            public static partial string WebUIDecode(string content);

            [LibraryImport(LibraryName, StringMarshalling = StringMarshalling.Utf8, EntryPoint = "webui_malloc")]
            [UnmanagedCallConv(CallConvs = new[] { typeof(CallConvCdecl) })]
            public static partial IntPtr WebUIMalloc(UIntPtr size);

            [LibraryImport(LibraryName, StringMarshalling = StringMarshalling.Utf8, EntryPoint = "webui_free")]
            [UnmanagedCallConv(CallConvs = new[] { typeof(CallConvCdecl) })]
            public static partial void WebUIFree(IntPtr pointer);

            [LibraryImport(LibraryName, StringMarshalling = StringMarshalling.Utf8, EntryPoint = "webui_set_tls_certificate")]
            [UnmanagedCallConv(CallConvs = new[] { typeof(CallConvCdecl) })]
            [return: MarshalAs(UnmanagedType.I1)]
            public static partial bool WebUISetTlsCertificate(string certPem, string privateKeyPem);

            [LibraryImport(LibraryName, StringMarshalling = StringMarshalling.Utf8, EntryPoint = "webui_interface_is_app_running")]
            [UnmanagedCallConv(CallConvs = new[] { typeof(CallConvCdecl) })]
            [return: MarshalAs(UnmanagedType.I1)]
